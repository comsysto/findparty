 ...
 */
public class DefaultSigninActivity extends AccountAuthenticatorActivity {

    private final static String TAG = Constants.LOG_AUTH_PREFIX + DefaultSigninActivity.class.getSimpleName();
    ...
    private void authenticate(final String username, final String password) {
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    return DefaultSigninActivity.this.getPartyManagerApplication().authenticate(username, password);
    ...
    private OnTouchListener createErrorTextViewListener() {
        return new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                error.startAnimation(AnimationUtils.loadAnimation(DefaultSigninActivity.this, android.R.anim.fade_out));
